								...
								<ul>
									...
									<li>{{$folder->name}}
										...
										<span class="tree-actions">
											<a class="btn btn-xs btn-default add-sheet" 
												...
												href="{{action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@create')}}?folder_id={{$folder->id}}">
												...
												<li data-jstree='{ "icon" : "fas fa-file-excel" }'>
													...
													<span class="tree-actions">
														<a class="btn btn-xs btn-default text-success view-sheet" 
															...
															href="{{action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@show', [$spreadsheet->id])}}" target="_blank">
														...
														@if(auth()->user()->id == $spreadsheet->created_by)
															<a 
																...
																data-href="{{action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@destroy', [$spreadsheet->id])}}"
																href="{{action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@destroy', [$spreadsheet->id])}}">
																<i class="fas fa-trash-alt text-danger"></i>
															</a>
															<a 
																data-href="{{action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@getShareSpreadsheet', ['id' => $spreadsheet->id])}}" 
									...
									<li>@lang('spreadsheet::lang.untitled')
										<span class="tree-actions">
											<a class="btn btn-xs btn-default add-sheet" 
												title="@lang('spreadsheet::lang.create_spreadsheet')"
												href="{{action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@create')}}">
												<i class="fas fa-plus text-success"></i></a>
										</span>
										<ul>
