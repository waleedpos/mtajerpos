    ...
    <div class="container-fluid">
    	<div class="row">
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                @php
                    $redirect = action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@index');
                    if ($spreadsheet->created_by != auth()->user()->id) {
                        $redirect = action('\Modules\Essentials\Http\Controllers\ToDoController@index');
                    }
                @endphp
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                {!! Form::open(['url' => action('\Modules\Spreadsheet\Http\Controllers\SpreadsheetController@update', $spreadsheet->id), 'id' => 'spreadsheet', 'method' => 'put']) !!}
