...
class PrinterController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            $printer = Printer::where('business_id', $business_id)
                ->select([
                    ...
                    'capability_profile', 'char_per_line', 'ip_address', 'port', 'path', 'id', 'category_id',
                ]);
            ...
            return Datatables::of($printer)
                ...
                ->editColumn(
                    'category_id',
                    function ($row) {
                        $category = \App\Category::where('id', $row->category_id)->first();
                        if (isset($category)) {
    ...
    public function create()
    {
        ...
        return view('printer.create')
            ->with(compact('capability_profiles', 'connection_types', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $input = $request->only(['name', 'category_id', 'connection_type', 'capability_profile', 'ip_address', 'port', 'path', 'char_per_line']);
    ...
    public function edit($id)
    {
        ...
        return view('printer.edit')
            ->with(compact('printer', 'capability_profiles', 'connection_types', 'categories'));
    }
