...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::prefix('modules')->group(function () {
        ...
        Route::get('tables/{id}/edit', 'Restaurant\TableController@edit')->name('tables.edit');
        Route::delete('tables/{id}', 'Restaurant\TableController@destroy')->name('tables.destroy');


        Route::get('/modifier-sets/{id}/edit', [Restaurant\ModifierSetsController::class, 'edit'])->name('modifier_sets.edit');
        Route::get('/product-modifier-set/{id}/edit', [Restaurant\ProductModifierSetController::class, 'edit'])->name('product_modifier_set.edit');
        Route::delete('/modifier-sets/{id}', [Restaurant\ModifierSetsController::class, 'destroy'])->name('modifier_sets.destroy');
...
// Order Registeration
Route::get('/order-registeration', function(){
    return view('home.order_registeration');
});
Route::post('/order-registeration', [HomeController::class, 'submitRegisteration']);
