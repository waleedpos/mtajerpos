...
<html class="supernova"><head>
  ...
  <link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F231132791914454" title="oEmbed Form">
  <link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F231132791914454" title="oEmbed Form">
  <meta property="og:title" content="طلب تسجيل جديد">
  <meta property="og:url" content="https://form.jotform.com/231132791914454">
  <meta property="og:description" content="Please click the link to complete this form.">
  <meta name="slack-app-id" content="AHNMASS8M">
  <meta property="og:image" content="https://www.jotform.com/uploads/wbamassoud/form_files/Original%20on%20Transparent.644665bd85ccc4.76469537.png">
  <link rel="shortcut icon" href="https://cdn.jotfor.ms/assets/img/favicons/favicon-2021-dark%402x.png">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1">
  <meta name="HandheldFriendly" content="true">
  <title>طلب تسجيل جديد</title>
  <style type="text/css">@media print{.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}</style>
  <link type="text/css" rel="stylesheet" href="https://cdn01.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=3.3.41233&amp;themeRevisionID=5f7ed99c2c2c7240ba580251">
  <link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/css/styles/payment/payment_styles.css?3.3.41233">
  <link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.41233">
  <style type="text/css" id="form-designer-style">
    ...
    .supernova body {
      ...
      .form-all:before {
        content: "";
        background-image: url("https://www.jotform.com/uploads/wbamassoud/form_files/Original%20on%20Transparent.644665bd85ccc4.76469537.png");
        display: inline-block;
        height: 140px;
        position: absolute;
        background-size: 295px 140px;
      ...
      border-radius : 6px;
      box-shadow : 0 0 0px rgba(42, 42, 42, 0.16);
  }
      /* Injected CSS Code */
  </style>
  ...
  <body>
  <form class="jotform-form" action="###" method="post" name="form_231132791914454" id="myForm" accept-charset="utf-8" autocomplete="on" novalidate="true">
    @csrf
    <div role="main" class="form-all">
      <ul class="form-section page-section">
        <li id="cid_5" class="form-input-wide" data-type="control_head">
          <div class="form-header-group  header-large">
            <div class="header-text httal htvam">
              <h1 id="header_5" class="form-header" data-component="header">املأ البيانات التالية </h1>
              <div id="subHeader_5" class="form-subHeader">حسب الرخصة التجارية والسجل التجاري</div>
            </div>
          </div>
        </li>
        <li class="form-line jf-required" data-type="control_fullname" id="id_20" data-compound-hint="الاسم التجاري,اسم المالك"><label class="form-label form-label-left" id="label_20" for="first_20"> اسم المنشأة<span class="form-required">*</span> </label>
          <div id="cid_20" class="form-input jf-required" data-layout="full">
            <div data-wrapper-react="true"><span class="form-sub-label-container" style="vertical-align:top" data-input-type="first"><input type="text" id="first_20" required name="fullName[first]" class="form-textbox validate[required]" data-defaultvalue="" autocomplete="section-input_20 given-name" size="10" value="" placeholder="الاسم التجاري" data-component="first" aria-labelledby="label_20 sublabel_20_first" required=""><label class="form-sub-label" for="first_20" id="sublabel_20_first" style="min-height:13px" aria-hidden="false">الاسم التجاري </label></span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="last"><input type="text" id="last_20" name="fullName[last]" class="form-textbox validate[required]" data-defaultvalue="" autocomplete="section-input_20 family-name" size="15" value="" placeholder="اسم المالك" data-component="last" aria-labelledby="label_20 sublabel_20_last" required=""><label class="form-sub-label" for="last_20" id="sublabel_20_last" style="min-height:13px" aria-hidden="false">اسم المالك</label></span></div>
          </div>
        </li>
        <li class="form-line jf-required" data-type="control_phone" id="id_19"><label class="form-label form-label-left" id="label_19" for="input_19_area"> رقم جوال المنشأة<span class="form-required">*</span> </label>
          <div id="cid_19" class="form-input jf-required" data-layout="half">
            <div data-wrapper-react="true"><span class="form-sub-label-container" style="vertical-align:top" data-input-type="areaCode"><input type="tel" id="input_19_area" name="companyPhoneNumber[area]" class="form-textbox validate[required]" data-defaultvalue="" autocomplete="section-input_19 tel-area-code" value="" data-component="areaCode" aria-labelledby="label_19 sublabel_19_area" required=""><span class="phone-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="input_19_area" id="sublabel_19_area" style="min-height:13px" aria-hidden="false">Area Code</label></span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="phone"><input type="tel" id="input_19_phone" name="companyPhoneNumber[phone]" class="form-textbox validate[required]" data-defaultvalue="" autocomplete="section-input_19 tel-local" value="" data-component="phone" aria-labelledby="label_19 sublabel_19_phone" required=""><label class="form-sub-label" for="input_19_phone" id="sublabel_19_phone" style="min-height:13px" aria-hidden="false">Phone Number</label></span></div>
          </div>
        </li>
        <li class="form-line" data-type="control_widget" id="id_71"><label class="form-label form-label-left form-label-auto" id="label_71" for="input_71"> رقم السجل التجاري </label>
          <div id="cid_23" class="form-input jf-required" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><input type="email" id="input_23" name="numeral" class="form-textbox validate[required, Email] form-validation-error" data-defaultvalue="" style="width:310px" size="310" value="" placeholder="" data-component="email" aria-labelledby="label_23 sublabel_input_23" required=""><label class="form-sub-label" for="input_23" id="sublabel_input_23" style="min-height:13px" aria-hidden="false">..</label></span> </div>
        </li>
        <li class="form-line" data-type="control_phone" id="id_53"><label class="form-label form-label-left form-label-auto" id="label_53" for="input_53_area"> رقم جوال المالك </label>
          <div id="cid_53" class="form-input" data-layout="half">
            <div data-wrapper-react="true"><span class="form-sub-label-container" style="vertical-align:top" data-input-type="areaCode"><input type="tel" id="input_53_area" name="ownerPhoneNumber[area]" class="form-textbox" data-defaultvalue="" autocomplete="section-input_53 tel-area-code" value="" data-component="areaCode" aria-labelledby="label_53 sublabel_53_area"><span class="phone-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="input_53_area" id="sublabel_53_area" style="min-height:13px" aria-hidden="false">Area Code</label></span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="phone"><input type="tel" id="input_53_phone" name="ownerPhoneNumber[phone]" class="form-textbox" data-defaultvalue="" autocomplete="section-input_53 tel-local" value="" data-component="phone" aria-labelledby="label_53 sublabel_53_phone"><label class="form-sub-label" for="input_53_phone" id="sublabel_53_phone" style="min-height:13px" aria-hidden="false">Phone Number</label></span></div>
          </div>
        </li>
        <li class="form-line jf-required" data-type="control_email" id="id_23"><label class="form-label form-label-left" id="label_23" for="input_23"> E-mail<span class="form-required">*</span> </label>
          <div id="cid_23" class="form-input jf-required" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><input type="email" id="input_23" name="email" class="form-textbox validate[required, Email] form-validation-error" data-defaultvalue="" style="width:310px" size="310" value="" placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_23 sublabel_input_23" required=""><label class="form-sub-label" for="input_23" id="sublabel_input_23" style="min-height:13px" aria-hidden="false">example@example.com</label></span> </div>
        </li>
        <li class="form-line jf-required" data-type="control_textarea" id="id_69"><label class="form-label form-label-left form-label-auto" id="label_69" for="input_69"> العنوان<span class="form-required">*</span> </label>
          <div id="cid_69" class="form-input jf-required" data-layout="full"> <span class="form-sub-label-container" style="vertical-align:top"><textarea id="input_69" class="form-textarea validate[required] form-validation-error" name="address" style="width:648px;height:163px" data-component="textarea" required="" aria-labelledby="label_69 sublabel_input_69"></textarea><label class="form-sub-label" for="input_69" id="sublabel_input_69" style="min-height:13px" aria-hidden="false">العنوان - الشارع - الحي - المنطقة - الدولة</label></span> </div>
        </li>
        <li class="form-line form-field-hidden" style="display:none;" data-type="control_divider" id="id_51">
        ...
        <li class="form-line jf-required form-field-hidden" style="display:none;" data-type="control_widget" id="id_50"><label class="form-label form-label-left form-label-auto" id="label_50" for="input_50"> معلومات المنتج<span class="form-required">*</span> </label>
        ...
        <li class="form-line" data-type="control_textarea" id="id_22"><label class="form-label form-label-top" id="label_22" for="input_22"> ملاحظات اضافية </label>
          <div id="cid_22" class="form-input-wide" data-layout="full"> <span class="form-sub-label-container" style="vertical-align:top"><textarea id="input_22" class="form-textarea" name="notes" style="width:648px;height:100px" data-component="textarea" aria-labelledby="label_22 sublabel_input_22"></textarea><label class="form-sub-label" for="input_22" id="sublabel_input_22" style="min-height:13px" aria-hidden="false">اضافة الرقم الضريبي ان وجد</label></span> </div>
        </li>
        
        <li class="form-line" data-type="control_calculation" id="id_58"><label class="form-label form-label-left form-label-auto" id="label_58" for="input_58"> السعر المتفق عليه </label>
          <div id="cid_58" class="form-input" data-layout="half"> <input type="text" data-component="calculation" data-defaultvalue="0" class="form-textbox" data-type="input-textbox" id="input_58" name="price" value="0" size="20"> </div>
        </li>
        <li class="form-line" data-type="control_widget" id="id_60"><label class="form-label form-label-left form-label-auto" id="label_60" for="input_60"> اختيار موعد التركيب </label>
          <div id="cid_60" class="form-input" data-layout="full">
            <input type="date" name="date" id="dateInput">
          </div>
        </li>
        <style>
          /* Custom styles for input type date */
          input[type="date"] {
            padding: 10px;
          ...
          /* Optional styles for the date picker dropdown arrow */
          input[type="date"]::-webkit-calendar-picker-indicator {
            /* Custom styling for the dropdown arrow */
          }
        </style>
        <script>
          // JavaScript code to set default value to today's date + 10 days
          var today = new Date();
          ...
          document.getElementById("dateInput").value = futureDate;
        </script>
        <li class="form-line" data-type="control_button" id="id_2">
          <div id="cid_2" class="form-input-wide" data-layout="full">
            <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
              <button id="input_2" type="submit" class="form-submit-button form-submit-button-black_blue submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">Place Order</button></div>
          </div>
        </li>
      </ul>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
  var submitButton = document.getElementById("input_2");
  ...
  function validateForm() {
    ...
    // Check if any input field or textarea is empty or has blank content
    for (var i = 0; i < inputs.length; i++) {
      if (inputs[i].value === "") {
        alert("من فضلك إملأ جميع الحقول أولا");
...
<img id="event_tracking_image" aria-hidden="true" src="https://events.jotform.com/form/231132791914454/?ref=&amp;res=1920x1080&amp;eventID=1684094404929_231132791914454_7wLRkWf&amp;loc=file%253A%252F%252F%252FF%253A%252FAli%252FDownloads%252FORDER.HTML" alt="jftr" width="1" height="1" style="display: none;">
  <script src="https://cdn.jotfor.ms//js/vendor/smoothscroll.min.js?v=3.3.41233"></script>
  </body></html>