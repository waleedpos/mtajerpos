  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('category_id',__('printer.category') . ':*') !!}
            {!! Form::select('category_id', $categories, $printer->category_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
          </div>
        </div>
